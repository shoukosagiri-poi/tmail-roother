...
class Configuration extends Component {
    ...
    public function update() {
        ...
        $settings = Setting::whereIn('key', ['domains', 'fetch_seconds', 'fetch_messages_limit', 'forbidden_ids', 'blocked_domains', 'cron_password', 'delete', 'random', 'custom', 'after_last_email_delete', 'date_format', 'recaptcha', 'add_mail_in_title'])->get();
